<template>
  <ul class="slider">
    <li>
        ...
        <img src="https://img.onl/c2LymK" alt="Panel 1">
    </li>
    <li>
        <input type="radio" id="slide2" name="slide">
        <label for="slide2"></label>
        <img src="https://img.onl/ZhF" alt="Panel 2">
    </li>
    <li>
        <input type="radio" id="slide3" name="slide">
        <label for="slide3"></label>
        <img src="https://img.onl/UJH6g9" alt="Panel 3">
    </li>
    <li>
        <input type="radio" id="slide4" name="slide">
        <label for="slide4"></label>
        <img src="https://img.onl/N9JMkH" alt="Panel 4">
    </li>
</ul>
</template>
